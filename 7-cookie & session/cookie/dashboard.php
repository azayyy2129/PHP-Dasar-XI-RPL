  ...
  <div class="container-fluid bg-primary-subtle d-flex align-items-center justify-content-center" style="height: 100vh">
      ...
      <div class="row">
        <div class="kiri col-lg-4 ">
          <img src="dodo2.jpg" class="img-fluid col-12 rounded">
        </div>
        <div class="kanan col-lg-8 ">
          <h2 class="fw-bold pb-0">azay sidik</h2>
          <small>Admin Sekolah Dan Pengajar</small>
          <div class="col-12 py-3">
            <small>pengajar jurusan :</small><br>
            <span class="badge rounded-pill text-bg-primary">PPLG</span>
            <span class="badge rounded-pill text-bg-danger">TKR</span>
            <span class="badge rounded-pill text-bg-warning">TKJT</span>
          </div>
          <div class="row">
            <div class="col-8">
